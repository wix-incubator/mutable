...
/***/ function(module, exports, __webpack_require__) {
	...
	var defineType = _babelHelpers.interopRequire(__webpack_require__(7));
	
	var BaseType = _babelHelpers.interopRequire(__webpack_require__(8));
	
	var stringType = _babelHelpers.interopRequire(__webpack_require__(9));
	
	var numberType = _babelHelpers.interopRequire(__webpack_require__(10));
	
	var arrayType = _babelHelpers.interopRequire(__webpack_require__(11));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ = _babelHelpers.interopRequire(__webpack_require__(26));
	
	var defineTypeUtils = _babelHelpers.interopRequireWildcard(__webpack_require__(20));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BaseType = (function () {
	    function BaseType(value) {
	        ...
	        _babelHelpers.classCallCheck(this, BaseType);
	    ...
	    _babelHelpers.prototypeProperties(BaseType, {
	        create: {
	        ...
	        wrapValue: {
	            value: function wrapValue(value, spec, isReadOnly, options) {
	                _core.Object.keys(spec).forEach(function (key) {
	        ...
	        toJSON: {
	            value: function toJSON() {
	                ...
	                return _core.Object.keys(this.constructor._spec).reduce(function (json, key) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var generateWithDefaultForSysImmutable = __webpack_require__(20).generateWithDefaultForSysImmutable;
	
	var _String = (function () {
	    function _String(value) {
	        _babelHelpers.classCallCheck(this, _String);
	
	        return String(value);
	    }
	
	    _babelHelpers.prototypeProperties(_String, {
	        defaults: {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Number = (function () {
	    function _Number(value) {
	        _babelHelpers.classCallCheck(this, _Number);
	
	        return Number(value);
	    }
	
	    _babelHelpers.prototypeProperties(_Number, {
	        defaults: {
	            value: function defaults() {
	                return 0;
	            },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var number = _babelHelpers.interopRequire(__webpack_require__(10));
	
	var generateWithDefault = __webpack_require__(20).generateWithDefault;
	
	var _Array = (function (BaseType) {
	    function _Array() {
	        var value = arguments[0] === undefined ? [] : arguments[0];
	        var isReadOnly = arguments[1] === undefined ? false : arguments[1];
	        var options = arguments[2] === undefined ? {} : arguments[2];
	
	        _babelHelpers.classCallCheck(this, _Array);
	    ...
	    _babelHelpers.inherits(_Array, BaseType);
	
	    _babelHelpers.prototypeProperties(_Array, {
	        defaults: {
	            value: function defaults() {
	                return [];
	            },
	        ...
	        wrapValue: {
	            value: function wrapValue(value, spec, isReadOnly, options) {
	                ...
	                return value.reduce(function (wrappedList, itemValue) {
	                    wrappedList.push(_this._wrapSingleItem(itemValue, isReadOnly, options));
	                    return wrappedList;
	                }, []);
	            },
	            writable: true,
...
/***/ function(module, exports, __webpack_require__) {
	...
	function generateTest() {
	    ...
	    return function (val) {
	        return _core.Object.keys(this._spec).every(function (key) {
	...
	function generateWithDefault() {
	    return function withDefault(defaults, test, options) {
	        ...
	        if (defaults !== undefined) {
	            ...
	            def = typeof defaults === "function" ? defaults : function () {
	...
	function generateGetDefaultValue() {
	    return function () {
	        var spec = this._spec;
	        var args = arguments;
	        return _core.Object.keys(this._spec).reduce(function (val, key) {
...
/***/ }
/******/ ])
//# sourceMappingURL=typorama.bundle.js.map